...
export const NAVIGATION_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'font-bold', labelId: 'Bold / Tebal', labelEn: 'Bold Sans', href: '/font/tebal', descriptionId: 'Teks tebal sans-serif penjelas' },
      { id: 'font-bubble', labelId: 'Bubble Text', labelEn: 'Bubble Text', href: '/font/gelembung', descriptionId: 'Huruf dilingkari lingkaran' },
      { id: 'font-cursive', labelId: 'Cursive / Script', labelEn: 'Cursive Script', href: '/font/miring-kursif', descriptionId: 'Tulisan tangan halus dan anggun' },
      { id: 'font-gothic', labelId: 'Gothic / Fraktur', labelEn: 'Gothic Medieval', href: '/font/gothic-fraktur', descriptionId: 'Kaligrafi abad pertengahan' },
      ...
      { id: 'font-sparkly', labelId: 'Sparkly Text', labelEn: 'Sparkly Text', href: '/font/berkilau', descriptionId: 'Efek teks berkilau bintang' },
