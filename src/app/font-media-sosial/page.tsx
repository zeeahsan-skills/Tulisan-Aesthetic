...
import PlatformClientPage from '../platform/PlatformClientPage';
import { PLATFORM_PILLAR_FAQS } from '@/lib/platform-pillar-faqs';

export const metadata: Metadata = {
  title: 'Font Media Sosial Generator - Converter Bio IG, TikTok, WA & Discord 2026',
  description:
    'Pusat alat generator font media sosial gratis di Indonesia. Ubah tulisan biasa menjadi font aesthetic untuk bio Instagram, caption TikTok, status WhatsApp, postingan Facebook & role Discord.',
  keywords: [
    'font media sosial',
    'font bio instagram',
    'font caption tiktok',
  ...
  alternates: {
    canonical: 'https://tulisanaesthetic.id/font-media-sosial',
  },
  openGraph: {
    title: 'Font Media Sosial Generator - Converter Bio IG, TikTok, WA & Discord',
    description:
    ...
    url: 'https://tulisanaesthetic.id/font-media-sosial',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        '@type': 'ListItem',
        position: 2,
        name: 'Font Media Sosial Generator',
        item: 'https://tulisanaesthetic.id/font-media-sosial',
      },
    ],
  };
