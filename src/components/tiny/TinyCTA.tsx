...
export function TinyCTA() {
  return (
    <section className="py-20 bg-white dark:bg-slate-900 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="relative rounded-3xl p-8 sm:p-16 bg-gradient-to-r from-purple-600 via-pink-500 to-teal-500 text-white text-center shadow-2xl shadow-purple-500/30 overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/20 backdrop-blur-md text-xs font-bold uppercase tracking-wider text-white">
              ...
              Font Kecil Generator #1 Indonesia
            </span>

            <h2 className="mt-6 text-3xl sm:text-5xl font-extrabold font-poppins leading-tight">
              Mulai Membuat Font Kecil Sekarang!
            </h2>

            <p className="mt-4 text-base sm:text-xl text-purple-100 max-w-2xl mx-auto leading-relaxed">
              Konversi teks Anda menjadi tulisan kecil superscript, subscript, dan Small Caps estetik dalam hitungan detik.
            </p>
