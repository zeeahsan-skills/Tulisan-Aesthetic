...
interface MenakutkanExamplesProps {
  onCopy: (msg: string) => void;
}

export function MenakutkanExamples({ onCopy }: MenakutkanExamplesProps) {
  const [copiedIndex, setCopiedIndex] = useState<number | null>(null);

  const rawExamples = [
    { plain: 'Ghost', styleId: 'glitch-text' },
    { plain: 'Zombie', styleId: 'zalgo-heavy' },
    { plain: 'Nightmare', styleId: 'horror-gothic' },
    { plain: 'Demon', styleId: 'creepy-blackletter' },
    { plain: 'Monster', styleId: 'demon-skull' },
    { plain: 'Shadow', styleId: 'horror-crosses' },
    { plain: 'Dark', styleId: 'creepy-wings' },
    { plain: 'Haunted', styleId: 'zalgo-brackets' },
    { plain: 'Death', styleId: 'creepy-japanese' },
    { plain: 'Skull', styleId: 'demon-clan' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h2 className="mt-4 text-3xl sm:text-5xl font-extrabold text-slate-900 dark:text-white font-poppins">
            Contoh Teks Menakutkan Siap Pakai
          </h2>
        ...
        <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {rawExamples.map((ex, idx) => {
            const style = SCARY_FONT_STYLES.find((s) => s.id === ex.styleId) || SCARY_FONT_STYLES[0];
            ...
            return (
              <motion.div
                ...
                className="group p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-purple-900/30 hover:border-rose-500/50 shadow-md hover:shadow-xl transition flex flex-col justify-between"
              >
                <div>
