...
import { Sparkles, Skull, RefreshCw, Circle, Type, PenTool, ArrowUpRight } from 'lucide-react';
...
export function RelatedFonts() {
  const relatedList = [
    ...
    {
      title: 'Font Memutar (Upside Down)',
      href: '/font/memutar',
      preview: 'ɐɥsɐu ʇnlısɐu',
      desc: 'Huruf terbalik 180° dan cermin urutan aesthetic.',
      icon: RefreshCw,
          ...
          {relatedList.map((rf, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group relative rounded-3xl p-6 bg-slate-50/70 dark:bg-slate-950/70 border border-slate-200/80 dark:border-purple-900/30 hover:border-rose-500/50 transition-all duration-300 flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <a
                      href={rf.href}
                      className="p-2 rounded-xl text-slate-400 hover:text-rose-600 dark:hover:text-pink-400 hover:bg-white dark:hover:bg-slate-800 transition"
                    >
                  ...
                  <div className="mt-2 p-2.5 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800 font-mono text-base font-medium text-rose-600 dark:text-rose-300">
                    {rf.preview}
                  </div>
