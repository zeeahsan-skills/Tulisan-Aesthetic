...
export function FontTebalPlatforms() {
  const platformList = [
    {
      id: 'instagram',
      title: 'Font Tebal untuk Instagram',
      subtitle: 'Penekanan judul pada Bio IG & Caption',
      icon: InstagramIcon,
      color: 'from-pink-500 via-purple-500 to-amber-500',
      link: '/platform/instagram',
      content:
        'Gunakan Font Tebal Bold Sans pada baris pertama Bio Instagram Anda untuk menciptakan visual headline yang jelas dan profesional. Teks tebal menarik perhatian pengunjung dalam hitungan detik.',
    },
    {
      id: 'tiktok',
      title: 'Font Tebal untuk TikTok',
      subtitle: 'Nama tampilan & komentar yang menonjol di FYP',
      icon: TikTokIcon,
      color: 'from-cyan-500 via-slate-900 to-pink-500',
      link: '/platform/tiktok',
      content:
        'Pada TikTok, membuat nama akun atau teks pembuka caption menggunakan Font Tebal membantu konten Anda lebih mudah dibaca dan diingat oleh penonton di feed FYP.',
    },
    {
      id: 'whatsapp',
      title: 'Font Tebal untuk WhatsApp',
      subtitle: 'Penjelas informasi penting di Chat & Status WA',
      icon: WhatsAppIcon,
      color: 'from-emerald-500 to-teal-600',
      link: '/platform/whatsapp',
      content:
        'Selain format *tebal* bawaan WA, Anda dapat menempelkan Font Tebal Bold Serif Unicode untuk membuat nama profil (About) dan pesan pengumuman grup terlihat rapi dan elegan.',
    },
    {
      id: 'facebook',
      title: 'Font Tebal untuk Facebook',
      subtitle: 'Postingan FB & nama grup yang menarik perhatian',
      icon: FacebookIcon,
      color: 'from-blue-600 to-indigo-700',
      link: '/platform/facebook',
      content:
        'Facebook tidak memiliki tombol penebal teks pada postingan biasa. Dengan menempelkan Font Tebal Unicode, postingan promosi atau status Anda otomatis tampil bold di kabar berita (News Feed).',
    },
    {
      id: 'discord',
      title: 'Font Tebal untuk Discord',
      subtitle: 'Nama role server & nickname member VIP',
      icon: DiscordIcon,
      color: 'from-indigo-500 to-purple-600',
      link: '/platform/discord',
      content:
        'Di Discord, Font Tebal Unicode sangat populer dipakai untuk nama role server VIP, judul channel obrolan, serta display name pengguna agar tampak lebih menonjol di daftar anggota.',
    },
  ];

  return (
    <section id="font-tebal-platform" className="py-16 sm:py-24 bg-slate-50/50 dark:bg-slate-950/50 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h2 className="mt-4 text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white font-poppins">
            Font Tebal untuk Berbagai Platform
          </h2>
          <p className="mt-3 text-base sm:text-lg text-slate-600 dark:text-slate-300">
            Implementasi terbaik penggunaan teks tebal Unicode untuk memaksimalkan profil dan pesan Anda.
          </p>
        </div>
