...
import { Type, Italic, Sparkles, Shield, Square, User, ArrowRight, Wand2 } from 'lucide-react';

export function FontTebalRelated() {
  const fontPages = [
    {
      title: 'Huruf Keren',
    ...
    },
    {
      ...
      desc: 'Converter teks miring Italic & tulisan tangan sambung.',
      icon: Italic,
