...
import { Bold, ArrowUp } from 'lucide-react';

export function FontTebalCTA() {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-xs sm:text-sm font-semibold backdrop-blur-md mb-6">
            <Bold className="w-4 h-4 text-pink-400" />
            <span>Buat Tulisan Tebal Anda Sekarang</span>
          </span>

          <h2 className="text-3xl sm:text-5xl font-extrabold font-poppins leading-tight">
            Tebalkan Teks Anda Secara Instan
          </h2>
          <p className="mt-4 text-base sm:text-lg text-slate-300 max-w-2xl mx-auto">
            Gunakan Font Tebal Generator gratis ini untuk menghasilkan tulisan bold aesthetic yang siap disalin ke Instagram, WhatsApp, TikTok, FB, dan Game.
          </p>
