...
export function BlogSection() {
  ...
  const articles = [
    ...
    {
      id: 5,
      title: 'Top 50 Kaomoji & Simbol Aesthetic Paling Populer di Tahun 2026',
      category: 'Simbol & Trend',
      readTime: '4 min baca',
      date: '10 Juli 2026',
      snippet: 'Kumpulan kaomoji imut (⁠っ⁠.⁠❛⁠ ⁠.⁠❛⁠)⁠っ dan simbol bunga ✿ bintang ★ yang siap disalin langsung untuk profil Anda.',
      image: '🌸',
    },
  ];
