...
import { ML_FAQS } from '@/lib/mobile-legends-faqs';

export const MlFAQ: React.FC = () => {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-2xl sm:text-4xl font-extrabold mb-3">
            FAQ Generator Nama Mobile Legends
          </h2>
          <p className="text-slate-400 text-sm sm:text-base">
            Jawaban lengkap seputar penggunaan font aesthetic, simbol khusus, batasan karakter, dan keamanan akun MLBB.
          </p>
        </div>
