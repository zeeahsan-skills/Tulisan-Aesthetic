...
import { VALORANT_FAQS } from '@/lib/valorant-faqs';

export function ValorantFAQ() {
  ...
  const faqSchema = {
    ...
    '@type': 'FAQPage',
    mainEntity: VALORANT_FAQS.map((item) => ({
      '@type': 'Question',
      name: item.q,
      acceptedAnswer: {
        '@type': 'Answer',
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold font-poppins mb-4">
            FAQ Nickname & Riot ID Valorant
          </h2>
          <p className="text-slate-400 text-sm sm:text-base">
            Jawaban lengkap seputar cara ganti nama Valorant, aturan 90 hari, simbol Unicode, dan format Riot ID.
          </p>
        </div>

        <div className="space-y-3">
          {VALORANT_FAQS.map((faq, idx) => {
