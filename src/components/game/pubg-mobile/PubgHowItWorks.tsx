...
export function PubgHowItWorks() {
  const steps = [
    {
      num: '01',
      title: 'Masukkan Teks Nama',
      icon: Edit3,
      desc: 'Ketik nama akun atau tag klan PUBG Mobile Anda pada kolom generator di atas.',
    },
    {
      num: '02',
      title: 'Generate Teks & Simbol',
      icon: Wand2,
      desc: 'Sistem generator kami secara otomatis (<10ms) mengonversi teks ke puluhan variasi gaya Unicode.',
    },
    {
      num: '03',
      title: 'Salin Hasil Nickname',
      icon: Copy,
      desc: 'Klik tombol "Salin Nama" pada hasil gaya font aesthetic yang Anda inginkan.',
    },
    {
      num: '04',
      title: 'Gunakan di PUBG Mobile',
      icon: CheckCircle2,
      desc: 'Buka PUBG Mobile, gunakan Rename Card di Inventory, paste teks tersebut, lalu konfirmasi.',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h2 className="mt-4 text-3xl sm:text-5xl font-extrabold text-slate-900 dark:text-white font-poppins">
            4 Langkah Mudah Membuat Nama PUBG Mobile
          </h2>
          <p className="mt-4 text-base sm:text-lg text-slate-600 dark:text-slate-400">
            Proses instan tanpa instalasi aplikasi tambahan, aman, dan 100% gratis selamanya.
          </p>
        </div>
