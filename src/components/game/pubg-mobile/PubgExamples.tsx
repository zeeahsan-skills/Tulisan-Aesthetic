...
interface PubgExamplesProps {
  onCopy: (msg: string) => void;
}

export function PubgExamples({ onCopy }: PubgExamplesProps) {
  const [copiedText, setCopiedText] = useState<string | null>(null);

  const presets = [
    {
      category: 'Predator',
      title: 'Predator Killer PUBG',
      preview: '乂 P R E D A T O R 乂',
    },
    {
      category: 'Shadow',
      title: 'Shadow Assassin Clan',
      preview: '父S H A D O W父',
    },
    {
      category: 'Hunter',
      title: 'Headshot Hunter Pro',
      preview: '『PUBG』H U N T E R',
    },
    {
      category: 'Legend',
    ...
    },
    {
      ...
      preview: '【 Clan 】A L P H A',
    },
    {
      category: 'Dragon',
      title: 'Dragon Flame Warrior',
      preview: '帝•D R A G O N•帝',
    },
    {
      category: 'Ghost',
      title: 'Ghost Stealth Sniper',
      preview: '⦇G H O S T⦈',
    },
    {
      category: 'Sniper',
      title: 'AWM One Shot Sniper',
      preview: '乡S N I P E R乡',
    },
    {
      category: 'King',
      title: 'King Conqueror VIP',
      preview: '『V I P』K I N G 👑',
    },
    {
      category: 'Queen',
  ...
  const handleCopyPreset = (text: string) => {
    ...
    setCopiedText(text);
    onCopy('Nama PUBG Mobile berhasil disalin!');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h2 className="mt-4 text-3xl sm:text-5xl font-extrabold text-slate-900 dark:text-white font-poppins">
            Template Nama PUBG Mobile Siap Pakai
          </h2>
          <p className="mt-4 text-base sm:text-lg text-slate-600 dark:text-slate-400">
            Klik salin pada preset di bawah ini untuk langsung memakai nickname PUBG Mobile populer di dalam game.
          </p>
        </div>
