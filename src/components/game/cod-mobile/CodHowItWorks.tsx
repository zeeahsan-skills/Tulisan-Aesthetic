...
export const CodHowItWorks: React.FC = () => {
  const steps = [
    {
      step: '01',
      title: 'Ketik Nama CODM Anda',
      desc: 'Masukkan nickname atau tag clan yang diinginkan pada kolom generator live di bagian atas.',
      icon: <Type className="w-6 h-6 text-orange-400" />,
    },
    {
      step: '02',
      title: 'Pilih Gaya Font & Simbol Taktis',
      desc: 'Jelajahi 30+ variasi Unicode estetik berornamen militer, tengkorak, dan tag clan.',
    ...
    {
      step: '04',
      title: 'Tempel di Game COD Mobile',
      desc: 'Buka game CODM > Profil > Ganti Nama, lalu pasang nickname estetik baru Anda dengan Rename Card.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-2xl sm:text-4xl font-extrabold mb-3">
            Cara Menggunakan Generator Nama COD Mobile
          </h2>
          <p className="text-slate-400 text-sm sm:text-base">
            4 langkah praktis membuat nickname CODM estetik hanya dalam hitungan detik.
          </p>
        </div>
