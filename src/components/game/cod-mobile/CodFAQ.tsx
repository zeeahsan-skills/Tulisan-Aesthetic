...
import { COD_FAQS } from '@/lib/cod-mobile-faqs';

export const CodFAQ: React.FC = () => {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-2xl sm:text-4xl font-extrabold mb-3">
            FAQ Generator Nama COD Mobile
          </h2>
          <p className="text-slate-400 text-sm sm:text-base">
            Jawaban lengkap seputar penggunaan font aesthetic, simbol militer, batasan karakter, dan cara ganti nama di CODM.
          </p>
        </div>

        {/* Accordions */}
        <div className="space-y-3">
          {COD_FAQS.map((faq, idx) => {
