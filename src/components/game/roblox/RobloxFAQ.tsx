...
import { ROBLOX_FAQS } from '@/lib/roblox-faqs';

export const RobloxFAQ: React.FC = () => {
  ...
  const faqSchema = {
    ...
    '@type': 'FAQPage',
    mainEntity: ROBLOX_FAQS.map((item) => ({
      '@type': 'Question',
      name: item.q,
      acceptedAnswer: {
        '@type': 'Answer',
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-2xl sm:text-4xl font-extrabold mb-3">
            FAQ Generator Nama Roblox
          </h2>
          <p className="text-slate-400 text-sm sm:text-base">
            Jawaban lengkap seputar penggunaan font aesthetic, simbol khusus, batasan karakter, dan cara ganti Display Name di Roblox.
          </p>
        </div>

        {/* Accordions */}
        <div className="space-y-3">
          {ROBLOX_FAQS.map((faq, idx) => {
