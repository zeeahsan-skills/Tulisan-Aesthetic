...
export const RobloxHowItWorks: React.FC = () => {
  const steps = [
    {
      step: '01',
      title: 'Ketik Nama Roblox Anda',
      desc: 'Masukkan username atau kata kunci yang diinginkan pada kolom generator live di bagian atas.',
      icon: <Type className="w-6 h-6 text-emerald-400" />,
    },
    {
      step: '02',
      title: 'Pilih Gaya Font & Simbol Estetik',
      desc: 'Jelajahi 30+ variasi font Unicode estetik (Gothic, Small Caps, Cute, VIP, Anime, dll).',
      icon: <Sparkles className="w-6 h-6 text-teal-400" />,
    },
    {
      step: '03',
      title: 'Salin 1-Klik (Copy)',
      desc: 'Ketuk tombol Copy pada kartu gaya favorit Anda untuk langsung menyalin ke clipboard HP/PC.',
      icon: <Copy className="w-6 h-6 text-cyan-400" />,
    },
    {
      step: '04',
      title: 'Tempel di Pengaturan Roblox',
      desc: 'Buka Roblox > Account Settings > Display Name, lalu tempelkan nama baru Anda secara gratis.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-2xl sm:text-4xl font-extrabold mb-3">
            Cara Menggunakan Roblox Name Generator
          </h2>
          <p className="text-slate-400 text-sm sm:text-base">
            4 langkah praktis membuat Roblox Display Name estetik hanya dalam hitungan detik.
          </p>
        </div>
