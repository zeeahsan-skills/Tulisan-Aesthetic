...
import { FREE_FIRE_FAQS } from '@/lib/free-fire-faqs';

export function FreeFireFAQ() {
  ...
  const faqSchema = {
    ...
    '@type': 'FAQPage',
    mainEntity: FREE_FIRE_FAQS.map((faq) => ({
      '@type': 'Question',
      name: faq.q,
      acceptedAnswer: {
        '@type': 'Answer',
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-base sm:text-lg text-slate-600 dark:text-slate-400">
            Jawaban lengkap untuk semua pertanyaan umum seputar pemodelan nama estetik di Garena Free Fire.
          </p>
        </div>

        <div className="mt-12 space-y-4">
          {FREE_FIRE_FAQS.map((faq, idx) => {
