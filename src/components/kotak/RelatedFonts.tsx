...
import { Sparkles, Circle, Type, PenTool, ArrowUpRight } from 'lucide-react';
...
export function RelatedFonts() {
  const relatedList = [
    ...
    {
      title: 'Font Terhubung (Sambung)',
      href: '/font/terhubung',
      preview: '𝒜𝒽𝓈𝒶𝓃 𝒯𝓊𝓁𝒾𝓈𝒶𝓃',
      desc: 'Teks tulisan tangan latin sambung yang terhubung lancar.',
      icon: PenTool,
              ...
              >
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <a
                      href={rf.href}
                      className="p-2 rounded-xl text-slate-400 hover:text-cyan-600 dark:hover:text-blue-400 hover:bg-white dark:hover:bg-slate-800 transition"
                    >
