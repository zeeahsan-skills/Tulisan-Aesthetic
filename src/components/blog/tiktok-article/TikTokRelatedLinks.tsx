...
import { ArrowRight, BookOpen, Type, Camera, MessageCircle, Video } from 'lucide-react';

export const TikTokRelatedLinks: React.FC = () => {
  const relatedLinks = [
    {
    ...
    {
      title: 'Font WhatsApp Guide',
      path: '/blog/font-whatsapp',
      desc: 'Trik memformat teks miring, tebal & font unik di obrolan WhatsApp.',
    ...
    {
      title: 'Generator Font TikTok',
      path: '/platform/tiktok',
      desc: 'Alat konversi teks instan khusus profil, bio & caption TikTok.',
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {relatedLinks.map((item, idx) => (
            ...
            >
              <Link
                href={item.path}
                className="bg-slate-950/80 border border-slate-800 hover:border-cyan-500/50 rounded-2xl p-4 flex flex-col justify-between group transition-all block h-full hover:-translate-y-0.5"
              >
                <div>
