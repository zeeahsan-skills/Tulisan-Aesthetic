...
export const TikTokFAQ: React.FC = () => {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-10">
          ...
          <p className="text-slate-400 text-xs sm:text-sm">
            Jawaban lengkap seputar cara penggunaan font aesthetic di profil, username, bio, dan caption TikTok.
          </p>
        </div>

        {/* Accordions */}
        <div className="space-y-3">
          {TIKTOK_ARTICLE_FAQS.map((faq, idx) => {
