...
export const ArticleFAQ: React.FC = () => {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-10">
          ...
          <h3 className="text-2xl sm:text-3xl font-extrabold mb-2">
            FAQ seputar Unicode & Font Aesthetic
          </h3>
          <p className="text-slate-400 text-xs sm:text-sm">
            Jawaban lengkap atas pertanyaan terbanyak seputar standar pengodean Unicode dan pemetaan font.
          </p>
        </div>

        {/* Accordions */}
        <div className="space-y-3">
          {UNICODE_ARTICLE_FAQS.map((faq, idx) => {
