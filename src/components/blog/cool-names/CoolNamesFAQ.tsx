...
export const CoolNamesFAQ: React.FC = () => {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-10">
          ...
          <h3 className="text-2xl sm:text-3xl font-extrabold mb-2">
            FAQ Pembuatan Nama Keren
          </h3>
          <p className="text-slate-400 text-xs sm:text-sm">
            Jawaban lengkap seputar tips merancang nickname unik, penggunaan font aesthetic Unicode, dan keamanan game.
          </p>
        </div>

        {/* Accordions */}
        <div className="space-y-3">
          {COOL_NAMES_ARTICLE_FAQS.map((faq, idx) => {
