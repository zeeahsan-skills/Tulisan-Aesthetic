...
export function VintageRelated() {
  const fontPages = [
    {
      title: 'Huruf Keren',
          ...
          {fontPages.map((item, idx) => {
            ...
            return (
              ...
              >
                <Link
                  href={item.url}
                  className="block h-full bg-white dark:bg-slate-900 rounded-2xl p-5 border border-slate-200 dark:border-purple-900/30 shadow-sm hover:shadow-md hover:border-amber-500/40 transition-all group"
                >
                  ...
                  <h3 className="text-base font-bold text-slate-900 dark:text-white font-poppins group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">
                    {item.title}
                  </h3>
                  ...
                  <div className="mt-4 pt-3 border-t border-slate-100 dark:border-slate-800/80">
                    <span className="text-xs font-semibold text-amber-700 dark:text-amber-300 font-mono">
                      {item.preview}
                    </span>
                  </div>
                </Link>
