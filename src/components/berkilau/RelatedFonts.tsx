...
export function RelatedFonts() {
  const relatedList = [
    ...
    {
      title: 'Font Menakutkan (Glitch)',
      href: '/font/menakutkan',
      preview: 'H̴̐͝e̸̽̽l̶̈́̽l̴̛̚o̸̎̍',
      desc: 'Efek teks seram Zalgo distorted untuk game nickname.',
      icon: Skull,
          ...
          {relatedList.map((rf, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group relative rounded-3xl p-6 bg-slate-50/70 dark:bg-slate-950/70 border border-slate-200/80 dark:border-purple-900/30 hover:border-amber-500/50 transition-all duration-300 flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <a
                      href={rf.href}
                      className="p-2 rounded-xl text-slate-400 hover:text-amber-600 dark:hover:text-pink-400 hover:bg-white dark:hover:bg-slate-800 transition"
                    >
                  ...
                  <div className="mt-2 p-2.5 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800 font-mono text-base font-medium text-amber-600 dark:text-amber-300">
                    {rf.preview}
                  </div>
