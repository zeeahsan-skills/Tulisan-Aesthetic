          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <div className="mt-8 flex justify-center">
              ...
              >
                ...
                <span>Generate Gothic Fonts</span>
