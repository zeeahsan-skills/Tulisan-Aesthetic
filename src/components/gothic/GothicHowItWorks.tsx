...
export function GothicHowItWorks() {
  const steps = [
    {
      step: '01',
      title: 'Ketik Teks Anda',
      desc: 'Masukkan teks biasa, nama akun, atau nickname gaming pada kolom generator di atas.',
      icon: Edit3,
    },
    {
      step: '02',
      title: 'Pilih Font Gothic & Fraktur',
      desc: 'Sistem generator otomatis mengonversi teks Anda menjadi 10+ variasi Unicode Gothic, Old English, dan Fraktur.',
      icon: Sparkles,
    },
    {
      step: '03',
      title: 'Salin & Tempel (Paste)',
      desc: 'Tekan tombol "Salin Teks", lalu tempelkan langsung ke Bio Instagram, Discord, atau Nickname Game Anda.',
      icon: CopyCheck,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h2 className="mt-4 text-3xl sm:text-5xl font-extrabold text-slate-900 dark:text-white font-poppins">
            3 Langkah Mudah Membuat Font Gothic
          </h2>
          <p className="mt-4 text-base sm:text-lg text-slate-600 dark:text-slate-400">
            Proses instan tanpa install aplikasi, tanpa pendaftaran, dan 100% gratis.
          </p>
        </div>
