      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <p className="mt-4 text-base sm:text-lg text-slate-600 dark:text-slate-400">
            Jawaban lengkap untuk pertanyaan umum seputar cara mengubah huruf profil, Info (About), WA Status, dan chat di WhatsApp.
          </p>
        </div>
        ...
        <div className="space-y-4">
          {WHATSAPP_FAQS.map((faq, idx) => {
            ...
            return (
              <div
                key={faq.q}
                className="rounded-2xl bg-slate-50 dark:bg-slate-950 border border-slate-200/80 dark:border-emerald-900/30 overflow-hidden transition-all"
              >
                <button
                ...
                >
                  ...
                  <div className={`p-2 rounded-xl bg-white dark:bg-slate-900 text-emerald-500 transition-transform duration-200 ${isOpen ? 'rotate-180' : ''}`}>
