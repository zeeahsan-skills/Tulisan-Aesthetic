...
import { Bold, Italic, Sparkles, Type, Shield, Square, User, ArrowRight } from 'lucide-react';

export function HurufKerenRelated() {
  const fontPages = [
    {
    ...
    },
    {
      ...
      desc: 'Generator teks miring dan tulisan tangan sambung.',
      icon: Italic,
