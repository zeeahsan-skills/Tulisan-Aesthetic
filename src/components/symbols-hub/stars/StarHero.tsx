...
import { Star, Search, Copy, Check } from 'lucide-react';
...
export const StarHero: React.FC<StarHeroProps> = ({
  searchQuery,
  setSearchQuery,
  onCopy,
}) => {
  ...
  const handleQuickCopy = () => {
    ...
    setCopiedQuick(true);
    onCopy('Kombinasi bintang populer berhasil disalin!');
    ...
    <section className="relative pt-12 pb-16 md:pt-16 md:pb-24 overflow-hidden bg-gradient-to-b from-slate-900 via-amber-950/30 to-slate-950 text-white">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10 text-center">
        ...
        >
          ...
          <span>Unicode Star Symbols Collection 2026</span>
        </motion.div>
        ...
        >
          <div className="relative">
            <input
              ...
              placeholder="Cari simbol bintang (contoh: black star, sparkle, rating, 5 star)..."
