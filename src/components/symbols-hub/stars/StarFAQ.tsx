...
import { STAR_FAQS } from '@/lib/star-symbol-faqs';

export const StarFAQ: React.FC = () => {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-2xl sm:text-4xl font-extrabold mb-3">
            FAQ Simbol Bintang (Star Symbols)
          </h2>
          <p className="text-slate-400 text-sm sm:text-base">
            Jawaban lengkap seputar penggunaan simbol bintang Unicode, penyalinan 1-klik, dan kompatibilitas media sosial & game.
          </p>
        </div>

        {/* Accordions */}
        <div className="space-y-3">
          {STAR_FAQS.map((faq, idx) => {
