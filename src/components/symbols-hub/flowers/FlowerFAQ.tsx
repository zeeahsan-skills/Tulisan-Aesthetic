...
import { FLOWER_FAQS } from '@/lib/flower-symbol-faqs';

export const FlowerFAQ: React.FC = () => {
  ...
  const faqSchema = {
    ...
    '@type': 'FAQPage',
    mainEntity: FLOWER_FAQS.map((item) => ({
      '@type': 'Question',
      name: item.q,
      acceptedAnswer: {
        '@type': 'Answer',
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-2xl sm:text-4xl font-extrabold mb-3">
            FAQ Simbol Bunga (Flower Symbols)
          </h2>
          <p className="text-slate-400 text-sm sm:text-base">
            Jawaban lengkap seputar penggunaan simbol bunga Unicode, sakura, mawar, penyalinan 1-klik, dan undangan digital.
          </p>
        </div>

        {/* Accordions */}
        <div className="space-y-3">
          {FLOWER_FAQS.map((faq, idx) => {
