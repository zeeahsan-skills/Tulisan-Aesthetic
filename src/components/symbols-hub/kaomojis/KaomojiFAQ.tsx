...
import { KAOMOJI_FAQS } from '@/lib/kaomoji-symbol-faqs';

export const KaomojiFAQ: React.FC = () => {
  ...
  const faqSchema = {
    ...
    '@type': 'FAQPage',
    mainEntity: KAOMOJI_FAQS.map((item) => ({
      '@type': 'Question',
      name: item.q,
      acceptedAnswer: {
        '@type': 'Answer',
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-2xl sm:text-4xl font-extrabold mb-3">
            FAQ Kaomoji Collection Hub
          </h2>
          <p className="text-slate-400 text-sm sm:text-base">
            Jawaban lengkap seputar penggunaan emotikon teks Jepang Kaomoji, penyalinan 1-klik, dan kompatibilitas game & sosial media.
          </p>
        </div>

        {/* Accordions */}
        <div className="space-y-3">
          {KAOMOJI_FAQS.map((faq, idx) => {
