...
import { CROWN_FAQS } from '@/lib/crown-symbol-faqs';

export const CrownFAQ: React.FC = () => {
  ...
  const faqSchema = {
    ...
    '@type': 'FAQPage',
    mainEntity: CROWN_FAQS.map((item) => ({
      '@type': 'Question',
      name: item.q,
      acceptedAnswer: {
        '@type': 'Answer',
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-2xl sm:text-4xl font-extrabold mb-3">
            FAQ Simbol Mahkota (Crown Symbols)
          </h2>
          <p className="text-slate-400 text-sm sm:text-base">
            Jawaban lengkap seputar penggunaan simbol mahkota Unicode, catur, penyalinan 1-klik, dan kompatibilitas game & sosial media.
          </p>
        </div>

        {/* Accordions */}
        <div className="space-y-3">
          {CROWN_FAQS.map((faq, idx) => {
