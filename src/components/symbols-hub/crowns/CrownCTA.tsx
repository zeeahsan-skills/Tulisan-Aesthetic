...
export const CrownCTA: React.FC = () => {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10 text-center">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold mb-4 tracking-tight">
            Copy Crown Symbols Instantly
          </h2>

          <p className="text-slate-300 text-sm sm:text-lg max-w-xl mx-auto mb-8 leading-relaxed">
            Salin 150+ simbol mahkota & kekaisaran aesthetic dan jelajahi ribuan kategori simbol unik lainnya untuk bio & nickname Anda.
          </p>

          <Link
            href="/simbol"
            className="inline-flex items-center gap-2 py-4 px-8 rounded-2xl bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600 hover:from-amber-400 hover:to-yellow-400 text-slate-950 font-extrabold text-base shadow-xl shadow-amber-500/20 transition-all hover:scale-105 active:scale-95"
          >
