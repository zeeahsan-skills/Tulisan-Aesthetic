...
import { CROWN_CATEGORIES_LIST } from '@/lib/crown-symbols';

interface CrownCategoriesProps {
  activeCategory: string;
  setActiveCategory: (cat: string) => void;
}

export const CrownCategories: React.FC<CrownCategoriesProps> = ({
  activeCategory,
  setActiveCategory,
}) => {
  return (
    <div className="flex flex-wrap items-center justify-center gap-2 mb-8 px-4">
      {CROWN_CATEGORIES_LIST.map((cat) => {
