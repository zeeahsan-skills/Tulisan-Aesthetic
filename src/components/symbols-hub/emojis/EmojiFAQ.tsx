...
import { EMOJI_FAQS } from '@/lib/emoji-symbol-faqs';

export const EmojiFAQ: React.FC = () => {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-2xl sm:text-4xl font-extrabold mb-3">
            FAQ Emoji Collection Hub
          </h2>
          <p className="text-slate-400 text-sm sm:text-base">
            Jawaban lengkap seputar penggunaan emoji Unicode, penyalinan 1-klik, render iOS vs Android, dan aksesibilitas.
          </p>
        </div>

        {/* Accordions */}
        <div className="space-y-3">
          {EMOJI_FAQS.map((faq, idx) => {
