...
import { Italic, ArrowUp } from 'lucide-react';

export function FontMiringKursifCTA() {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-xs sm:text-sm font-semibold backdrop-blur-md mb-6">
            ...
            <span>Buat Tulisan Miring &amp; Kursif Anda</span>
          </span>
          ...
          <p className="mt-4 text-base sm:text-lg text-slate-300 max-w-2xl mx-auto">
            Gunakan Font Miring &amp; Kursif Generator gratis ini untuk membuat Bio IG, status WA, dan caption TikTok Anda terlihat lebih aesthetic dan elegan.
          </p>
